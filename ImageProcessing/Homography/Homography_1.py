...
if __name__ == "__main__":
    ...
    source_image = cv2.imread("car1.jpg")
    ...
    destination_image_1 = cv2.warpPerspective(t_source_image, h, (1300, 1300))
    ...
    subplot2.title.set_text("Destination Image 2")
    subplot2.imshow(cv2.cvtColor(destination_image_1, cv2.COLOR_BGR2RGB))
